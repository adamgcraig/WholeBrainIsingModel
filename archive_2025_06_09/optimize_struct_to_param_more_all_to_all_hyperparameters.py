...
def train_mlp(sc_and_features_train:torch.Tensor, J_and_h_train:torch.Tensor, sc_and_features_validate:torch.Tensor, J_and_h_validate:torch.Tensor, num_hidden_layers:int=10, num_hidden_features:int=10, batch_size:int=670, learning_rate:float=0.001):
    ...
    num_samples, _, num_nodes_plus_num_features = sc_and_features_train.size()
    ...
    model = get_rectangular_mlp(in_features=num_nodes_plus_num_features, out_features=num_nodes_plus_num_params, num_hidden_layers=num_hidden_layers, hidden_layer_width=num_hidden_features, dtype=model_dtype, device=model_device)

...
srun python train_ising_model_on_transition_probabilities.py --data_directory data --output_directory results/ising_model --data_subset training --num_epochs 1000 --save_interval 10 --batch_size 8000 --learning_rate 0.000000001
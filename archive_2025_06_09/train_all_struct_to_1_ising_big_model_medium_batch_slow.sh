...
#SBATCH --mem=5G
#SBATCH --gres=gpu:1
#SBATCH --error=results/errors/train_all_struct_to_1_ising_big_model_medium_batch_slow_%j.err
#SBATCH --output=results/outs/train_all_struct_to_1_ising_big_model_medium_batch_slow_%j.out
#SBATCH --job-name="train_all_struct_to_1_ising_big_model_medium_batch_slow"

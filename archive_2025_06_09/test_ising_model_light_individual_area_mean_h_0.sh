...
#SBATCH --mem=5G
#SBATCH --gres=gpu:1
#SBATCH --error=results/errors/test_ising_model_individual_area_mean_h_0_%j.err
#SBATCH --output=results/outs/test_ising_model_individual_area_mean_h_0_%j.out
#SBATCH --job-name="fit_ising_model_individual_area_mean_h_0"

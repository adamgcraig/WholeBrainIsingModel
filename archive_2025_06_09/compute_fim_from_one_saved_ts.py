...
parser.add_argument("-f", "--sim_length", type=int, default=64980, help="number of simulation steps to run")
...
parser.add_argument("-r", "--device", type=str, default='cpu', help="device to which we want to load the model now")
parser.add_argument("-s", "--pca_iterations", type=int, default=10, help="number of iterations of lowrank PCA")
...
def get_augmented_time_series():
    ...
    save_to_cpu_and_print(mat=ts, mat_name='ts')

...
#SBATCH --mem=5G
#SBATCH --gres=gpu:1
#SBATCH --error=results/errors/compute_local_individual_correlations_1_long_%j.err
#SBATCH --output=results/outs/compute_local_individual_correlations_1_long_%j.out
#SBATCH --job-name="compute_local_individual_correlations_1_long"

...
#SBATCH --mem=5G
#SBATCH --gres=gpu:1
#SBATCH --error=results/errors/test_ising_model_light_mean_std_0_individual_10k_no_h_%j.err
#SBATCH --output=results/outs/test_ising_model_light_mean_std_0_individual_10k_no_h_%j.out
#SBATCH --job-name="fit_ising_model_light_mean_std_0_individual_10k_no_h"

...
#SBATCH --mem=5G
#SBATCH --gres=gpu:1
#SBATCH --error=results/errors/fit_ising_model_light_medium_mean_std_1_flip_rate_%j.err
#SBATCH --output=results/outs/fit_ising_model_light_medium_mean_std_1_flip_rate_%j.out
#SBATCH --job-name="fit_ising_model_light_medium_flip_rate_mean_std_1"
